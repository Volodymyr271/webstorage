<div class="doc">
    ...
    <div class="childDocsContainer">
        <table class="childDocs">
            ...
            <tr class="template hidden">
                ...
                <td name="revenue" style="max-width: 5px"></td>
    ...
    <div class="docMenu">
        ...
        <a href="#" name ="load" onClick="Selsheet(this, 'Выберите отчет по покупателю', 'load', 230)" >Выбрать</a> |
        <a href="#" name ="delete" onClick="deleteDoc(this)">Удалить</a> |
        <a href="#" name ="recalc" onClick="runDoc(this,'pages/clientsReport230l.php', 'recalculation', '');">Пересчитать</a> |
    ...
    <div class="objectData hidden">
        {
        "extension": 230,
        "library": "pages/clientsReport230l.php",
        "nameForm": ["num", " г"],
        "delMsg": "Отчет по покупателю успешно удален",
        "cancelDelMsg": "Удалить можно только последний отчет по покупателю",
        "saveMsg": "Отчет по покупателю успешно сохранен",
        "defaultTabName": "Отчет по покупателю",
        "link": "pages/clientsReport230.php",
        "isSaved": true,
        "id": "",
        "saveType": "save_new",
        "firstProperty": "#",
...
<!--<div class="doc">
	...
	<div class="docMenu">
        ...
        <p class="objectData" style="display:none;">{"extension": 230,
                                                       "library": "pages/clientsReport230l.php",
                                                       "nameForm": ["num", " г"],
                                                       "delMsg": "Отчет по покупателю успешно удален",
                                                       "cancelDelMsg": "Удалить можно только последний отчет по покупателю",

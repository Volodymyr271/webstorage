<div class="doc">
    ...
    <div class="docMenu">
        <a href="#" name="addExpenditureItem" onClick="Selsheet(this, 'Выберите статью расходов', 'InsPart', 40);" >Статья расходов</a>  |
        ...
        <a href="#" name="runDoc" onClick="runDoc(this, 'pages/expenditure130l.php','runDoc', '')">Провести</a> |
        <a href="#" name="load" onClick="Selsheet(this, 'Выберите расход', 'load', 130)">Выбрать</a> |
    ...
    <div class="objectData hidden">
        {
        "extension": 130,
        "library": "pages/expenditure130l.php",
        "nameForm": ["№ ", "num", " от ", "datdoc", " ", "cashier"],
        "delMsg": "Расход успешно удален",
        "saveMsg": "Расход успешно сохранен",
        "cancelSaveMsg": "Введите номер расхода",
        "defaultTabName": "Расход",
        "link": "pages/expenditure130.php",
        "isSaved": true,
        "id": "",
        "saveType": "save_new",
        "firstProperty": "хххх",
...
<!--<div class="doc">
	...
	<div class="docMenu">
        ...
        <p class="objectData" style="display:none;">{"extension": 130,
                                                       "library": "pages/expenditure130l.php",
                                                       "nameForm": ["№ ", "num", " от ", "datdoc", " ", "cashier"],
                                                       "delMsg": "Расход успешно удален",
                                                       "saveMsg": "Расход успешно сохранен",
